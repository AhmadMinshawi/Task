export const DATA_SCHEMA_V1 = Object.freeze({
  ...
  projects: ['id', 'ownerId', 'clientId', 'name', 'projectType', 'pricePerVideo', 'totalVideos', 'deadline', 'projectLink', 'status', 'notes', 'pinned', 'archivedAt', 'createdAt', 'updatedAt', 'deletedAt'],
