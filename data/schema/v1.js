export const DATA_SCHEMA_V1 = Object.freeze({
  ...
  clients: ['id', 'ownerId', 'name', 'email', 'phone', 'industry', 'archivedAt', 'createdAt', 'updatedAt', 'deletedAt'],
  projects: ['id', 'ownerId', 'clientId', 'name', 'pricePerVideo', 'totalVideos', 'pinned', 'archivedAt', 'createdAt', 'updatedAt', 'deletedAt'],
  tasks: ['id', 'ownerId', 'projectId', 'title', 'status', 'dueDate', 'archivedAt', 'createdAt', 'updatedAt', 'deletedAt'],
